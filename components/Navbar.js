...
const Navbar = () => {
  return (
    <div>
      <nav className="w-[90vw] h-23 top-12 left-1/2 transform justify-between items-center -translate-x-1/2 rounded-full fixed z-50 flex bg-white">
          ...
          <Link href="/">
            <button
              className=" bg-gray-200 hover:bg-gray-300
                        ...
                        rounded-xl font-bold px-8 py-5 shadow-lg"
            >
              Log in
            </button>
          </Link>
